export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description: 'the state of the content images inside the body of the page',
      options: {
        list: [
    ...
    // },
    {
      ...
      type: 'text',
      title: 'Notes',
      description: 'notes for other content editors (or yourself), on the content and status of this page'
    },
  ]
}
